/*
  ...
  gengetopt --output-dir autogen -i args.ggo --unamed-opts
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'a':	/* output all NMIs (sum-denominator and LFK besides the max-denominator one).  */
          ...
          break;
        case 'o':	/* print the Omega measure (can be slow).  */
          ...
          break;
        case 't':	/* use text ids of nodes instead of .cnl format.  */
